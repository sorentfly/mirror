...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Привет!"],
			morning: ["Утречка, красавец!", "Наслаждайся днём!", "Как поспал, братишка?"],
			afternoon: ["Хай красотка!", "Ух ты секси!", "Круто выглядишь!"],
			evening: ["Ух, а ты горяч!", "Выглядишь потрясно!", "Привет, секси!"],
			"....-01-01": ["С новым годом!"]
		},
